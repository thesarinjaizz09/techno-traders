...
const HeroSection = () => {
    ...
    `}>
            ...
            <div className="relative z-10 flex flex-col items-center justify-center text-center px-4 pt-20 pb-32 max-w-5xl mx-auto mt-10">
                <h1 className={`${openSans.className} text-6xl md:text-8xl font-sans font-semibold tracking-tight leading-[1.1] mb-8`}>
                    Trading with<br />
                    Option Mathematics
                </h1>

                <p className="text-gray-400 text-lg max-w-2xl mb-12 leading-relaxed font-semibold">
